...
<body>
    <nav class="bg-black flex items-center justify-between flex-wrap p-6">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
            <a href="index.html" title="the coffee house">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="lg:text-sm sm:text-3xl lg:flex-grow">
                ...
                <a href="sanpham.html" class="font-extrabold text-lg block mt-4 lg:inline-block lg:mt-0 text-white hover:text-orange-500 mr-4">
                    SẢN PHẨM
                </a>
                <a href="login.html" class="font-extrabold text-lg block mt-4 lg:inline-block lg:mt-0 text-white hover:text-orange-500">
                    ĐĂNG NHẬP
                </a>
            </div>
        </div>
        ...
        <div class="w-full p-0">
            <img src="https://file.hstatic.net/1000075078/file/kv_new_sori_web__a9d6c4916bb541d9a3af9c8c222f576f_master.jpg"/>
        </div>

    <main class="bg-white">
        <div class="container mx-auto mt-5">
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-start flex-wrap content-center">
                    <div class="sm:text-5xl text-3xl font-extrabold text-orange-500">MENU</div>
                </div>
                <div class="flex justify-end">
                    <button class="sm:text-4xl transition duration-500 ease-in-out bg-black text-white hover:text-black hover:bg-white px-3 border-black border-2 duration-500">
            ...
            <div class="grid lg:grid-cols-3 sm:grid-cols-1 gap-4 my-10">
                ...
                $query = $mysqli->prepare("select name, id, price from item order by rand() limit 6");
                $query->execute();
...
<!--                    <div class="px-6 pt-4 pb-2 mb-2">-->
<!--                        <div class="grid grid-cols-2 gap-4">-->
<!--                            <button class="border-orange-500 border-2 sm:text-3xl transition duration-500 ease-in-out bg-orange-500 bg-orange-500 text-white hover:text-orange-500 hover:bg-white px-3">-->
<!--                                MUA NGAY-->
<!--                            </button>-->
<!--                            <button class="border-orange-500 border-2 sm:text-3xl transition duration-500 ease-in-out  bg-white text-orange-500 hover:text-white hover:bg-orange-500 px-3">-->
<!--                                TÌM HIỂU THÊM-->
<!--                            </button>-->
<!--                        </div>-->
<!--                    </div>-->
