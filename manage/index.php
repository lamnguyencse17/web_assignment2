...
<nav class="bg-black flex items-center justify-between flex-wrap p-6">
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="lg:text-sm sm:text-3xl lg:flex-grow">
            <a href="account.html" class="font-extrabold text-lg block mt-4 lg:inline-block lg:mt-0 text-white hover:text-orange-500 mr-4">
                ACCOUNT MANAGEMENT
            </a>
            <a href="item.html" class="font-extrabold text-lg block mt-4 lg:inline-block lg:mt-0 text-white hover:text-orange-500 mr-4">
                ITEM MANAGEMENT
            </a>
